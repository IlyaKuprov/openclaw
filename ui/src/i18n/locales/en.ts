...
export const en: TranslationMap = {
  ...
  pluginsPage: {
    ...
    policyReviewBodyUnknown: "ClawScan flagged this plugin. It has not been installed.",
    policyReviewBodyOne: "ClawScan found 1 warning. This plugin has not been installed.",
    policyReviewBodyMany: "ClawScan found {count} warnings. This plugin has not been installed.",
    policyReviewReason: "Why it was flagged",
    policyReviewFindings: "What ClawScan found",
