...
The publication receipt confirms PR publication or reuse, not code review. The broker does not mark drafts ready or verify a reviewer verdict; complete any required PR review separately before reporting the PR task done.
