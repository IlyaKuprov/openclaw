...
| 1c  | Cleanup: node-pairing → device-pairing merge         | landed      | [#120726](https://github.com/openclaw/openclaw/pull/120726) |
| 2   | `openclaw resume` + web Continue in terminal         | not started | —                                                           |
| 3   | `oc-pair://` one-paste pairing                       | not started | —                                                           |
| 4   | Picker + enrichment + projects read model            | in review   | [#120804](https://github.com/openclaw/openclaw/pull/120804) |
