...
| `--dangerously-force-unsafe-install [acknowledgement-id]` | Re-evaluate and acknowledge the install-policy warning matching the exact returned ID during post-update plugin sync. A bare flag does not acknowledge a policy warning. Blocks and policy failures remain terminal.                                                                                                                         |
...
openclaw update repair --dangerously-force-unsafe-install <acknowledgement-id>
...
| `--dangerously-force-unsafe-install [acknowledgement-id]` | Same exact-ID install-policy warning acknowledgement behavior as on `openclaw update`.                                                                                                                                                                              |
