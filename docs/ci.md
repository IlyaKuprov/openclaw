...
| `macos-app-bootstrap`              | Package and launch the exact-head macOS app in a logged-in session, then verify incompatible-CLI rejection, matching CLI installation, LaunchAgent setup, and delayed Gateway-readiness recovery                      | macOS app/bootstrap-relevant changes           |
...
| `blacksmith-12vcpu-macos-26`    | `macos-swift`, `macos-app-bootstrap`, and `ios-build` on `openclaw/openclaw`; forks fall back to `macos-26`                                                                                                                                                                       |
