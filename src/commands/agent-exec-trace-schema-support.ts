...
export const MAX_DISPATCHES = 128;
...
const SOURCE_COVERAGE_REASONS = [
  ...
  "transport_dispatch_relation_invalid",
...
const TRACE_REASONS = [
  ...
  "dispatch_logical_call_ledger_incomplete",
  "dispatch_ledger_incomplete",
  "dispatch_attempt_ledger_incomplete",
  "dispatch_event_ledger_incomplete",
  "dispatch_route_not_singular",
  "dispatch_call_lifecycle_incomplete",
  "dispatch_global_sequence_invalid",
  "dispatch_attempt_conservation_mismatch",
...
export function parseFacts(value: unknown): SchemaSourceFacts | undefined {
  if (
    ...
    !hasKeys(value.duration, ["agentDurationMs", "commandExecutionDurationMs"])
  ) {
    return undefined;
  }
  const facts = {
