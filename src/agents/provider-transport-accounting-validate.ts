...
export function transportAttemptReasonMatches(
  actual: Extract<AiModelTransportEvent, { type: "attempt" | "dispatch" }>["reason"],
...
export function rejectTransportDispatchRelation(
  state: MutableProviderTransportAccounting,
  reason: Extract<
    ProviderTransportAccountingCoverageReason,
    "transport_dispatch_relation_incomplete" | "transport_dispatch_relation_invalid"
