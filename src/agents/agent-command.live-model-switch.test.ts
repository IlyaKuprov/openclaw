...
describe("agentCommand – LiveSessionModelSwitchError retry", () => {
  ...
  it("runs the ACP execution gate before manager submission and traces prompt readiness", async () => {
    setupAcpSession();
  ...
  it("stops before ACP manager submission when the execution gate fails", async () => {
    setupAcpSession();
